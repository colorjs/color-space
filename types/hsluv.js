...
//@ts-ignore
function f(a) { var c = [], b = Math.pow(a + 16, 3) / 1560896; b = b > g ? b : a / k; for (var d = 0; 3 > d;) {
...
function m(a) { a = f(a); for (var c = Infinity, b = 0; b < a.length;) {
    var d = a[b];
    ++b;
    c = Math.min(c, Math.abs(d.a) / Math.sqrt(Math.pow(d.b, 2) + 1));
} return c; }
//@ts-ignore
function n(a, c) { c = c / 360 * Math.PI * 2; a = f(a); for (var b = Infinity, d = 0; d < a.length;) {
    var e = a[d];
    ++d;
    e = e.a / (Math.sin(c) - e.b * Math.cos(c));
    0 <= e && (b = Math.min(b, e));
} return b; }
function p(a, c) { for (var b = 0, d = 0, e = a.length; d < e;) {
    var h = d++;
    b += a[h] * c[h];
} return b; }
...
function E(a) { var c = a[0]; if (0 == c)
    return [0, 0, 0]; var b = a[1] / (13 * c) + C; a = a[2] / (13 * c) + D; c = 8 >= c ? B * c / k : B * Math.pow((c + 16) / 116, 3); b = 0 - 9 * c * b / ((b - 4) * a - b * a); return [b, c, (9 * c - 15 * a * c - a * b) / (3 * a)]; }
//@ts-ignore
...
function H(a) { var c = a[0], b = a[1]; a = a[2]; if (99.9999999 < a)
    return [100, 0, c]; if (1E-8 > a)
    return [0, 0, c]; b = n(a, c) / 100 * b; return [a, b, c]; }
function I(a) { var c = a[0], b = a[1]; a = a[2]; if (99.9999999 < c)
    return [a, 0, 100]; if (1E-8 > c)
    return [a, 0, 0]; var d = n(c, a); return [a, b / d * 100, c]; }
//@ts-ignore
function J(a) { var c = a[0], b = a[1]; a = a[2]; if (99.9999999 < a)
    return [100, 0, c]; if (1E-8 > a)
    return [0, 0, c]; b = m(a) / 100 * b; return [a, b, c]; }
function K(a) { var c = a[0], b = a[1]; a = a[2]; if (99.9999999 < c)
    return [a, 0, 100]; if (1E-8 > c)
    return [a, 0, 0]; var d = m(c); return [a, b / d * 100, c]; }
function L(a) { for (var c = "#", b = 0; 3 > b;) {
    var d = b++;
...
//@ts-ignore
function N(a) { a = a.toLowerCase(); for (var c = [], b = 0; 3 > b;) {
    var d = b++;
