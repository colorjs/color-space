...
export default [
	...
	{ name: 'Colorimetry & vision', spaces: ['xyz', 'xyy', 'lms', 'xyz-d50', 'uv', 'cct-duv', 'kelvin', 'maxwell', 'wavelength', 'xyz-abs-d65', 'macboyn', 'dkl', 'gray', 'dsh', 'rg', 'yrg'] },
	{ name: 'Video & broadcast', spaces: ['ycbcr-bt709', 'ycbcr-bt2020', 'ycbcr-bt601-525', 'ycbcr-bt601-625', 'ycbcr', 'yuv', 'yiq', 'ypbpr', 'ycgco', 'jpeg', 'ydbdr', 'yccbccrc', 'xvycc', 'smpte-c', 'photoycc'] },
	{ name: 'Film & camera', spaces: ['acescg', 'acescc', 'logc3', 'slog3', 'sgamut3cine', 'aces2065-1', 'acescct', 'logc4', 'cineon', 'davinci', 'slog2', 'vlog', 'log3g10', 'clog', 'clog2', 'clog3', 'flog', 'flog2', 'nlog', 'applelog', 'bmdfilm', 'dlog', 'tlog', 'dcdm', 'slog', 'acesproxy', 'erimm', 'llog', 'protune', 'milog', 'olog', 'redlog', 'redlogfilm', 'log3g12', 'panalog', 'viperlog', 'filmicpro'] },
	...
	{ name: 'Specialty & research', spaces: ['xyb', 'osaucs', 'tsl', 'yes', 'ohta', 'lalphabeta'] },
]
