...
husl:f("./husl"),huslp:f("./huslp")};Object.defineProperty(f,"add",{value:function(e){var b=e.name;if(!this[b]){var c,d;for(d in this)c=this[d],a(e,c),a(c,e);return this[b]=e}}});var d,c;for(c in f){k=f[c];for(var e in f)e!==c&&(d=f[e],a(k,d))}g.exports=f},{"./add-convertor":1,"./cmyk":2,"./hsl":3,"./hsv":4,"./husl":5,"./huslp":6,"./hwb":7,"./lab":9,"./lchab":10,"./lchuv":11,"./luv":12,"./rgb":14,"./xyz":15}],9:[function(f,g,k){k=f("./xyz");f("./rgb");g.exports={name:"lab",min:[0,-100,-100],max:[100,
100,100],channel:["lightness","a","b"],alias:["cielab"],xyz:function(a){var d=a[0],c=a[1];a=a[2];var e,f,b;8>=d?(d=100*d/903.3,b=d/100*7.787+16/116):(d=100*Math.pow((d+16)/116,3),b=Math.pow(d/100,1/3));e=.008856>=e/95.047?e=95.047*(c/500+b-16/116)/7.787:95.047*Math.pow(c/500+b,3);f=.008859>=f/108.883?f=108.883*(b-a/200-16/116)/7.787:108.883*Math.pow(b-a/200,3);return[e,d,f]}};k.lab=function(a){var d=a[0],c=a[1];a=a[2];d/=95.047;c/=100;a/=108.883;d=.008856<d?Math.pow(d,1/3):7.787*d+16/116;c=.008856<
c?Math.pow(c,1/3):7.787*c+16/116;a=.008856<a?Math.pow(a,1/3):7.787*a+16/116;return[116*c-16,500*(d-c),200*(c-a)]}},{"./rgb":14,"./xyz":15}],10:[function(f,g,k){var a=f("./xyz"),d=f("./lab"),c=g.exports={name:"lchab",min:[0,0,0],max:[100,100,360],channel:["lightness","chroma","hue"],alias:["cielch","lch"],xyz:function(a){return d.xyz(c.lab(a))},lab:function(a){var c=a[0],b=a[1],d;d=a[2]/360*2*Math.PI;a=b*Math.cos(d);b*=Math.sin(d);return[c,a,b]}};d.lchab=function(a){var c=a[0],b=a[1],d=a[2];a=360*
Math.atan2(d,b)/2/Math.PI;0>a&&(a+=360);b=Math.sqrt(b*b+d*d);return[c,b,a]};a.lchab=function(c){return d.lchab(a.lab(c))}},{"./lab":9,"./xyz":15}],11:[function(f,g,k){var a=f("./luv"),d=f("./xyz"),c=g.exports={name:"lchuv",channel:["lightness","chroma","hue"],alias:["cielchuv"],min:[0,0,0],max:[100,100,360],luv:function(a){var c=a[0],b=a[1],d;d=a[2]/360*2*Math.PI;a=b*Math.cos(d);b*=Math.sin(d);return[c,a,b]},xyz:function(d){return a.xyz(c.luv(d))}};a.lchuv=function(a){var c=a[0],b=a[1],d=a[2];a=Math.sqrt(b*
b+d*d);b=360*Math.atan2(d,b)/2/Math.PI;0>b&&(b+=360);return[c,a,b]};d.lchuv=function(c){return a.lchuv(d.luv(c))}},{"./luv":12,"./xyz":15}],12:[function(f,g,k){var a=f("./xyz");f("./rgb");g.exports={name:"luv",min:[0,-134,-140],max:[100,224,122],channel:["lightness","u","v"],alias:["cieluv"],xyz:function(d,c,e){var f,b,h,g;h=d[0];f=d[1];b=d[2];if(0===h)return[0,0,0];c=c||"D65";e=e||2;g=a.whitepoint[e][c][0];d=a.whitepoint[e][c][1];c=a.whitepoint[e][c][2];f=f/(13*h)+4*g/(g+15*d+3*c)||0;b=b/(13*h)+
9*d/(g+15*d+3*c)||0;h=8<h?d*Math.pow((h+16)/116,3):d*h*.0011070564598794539;return[9*h*f/(4*b)||0,h,h*(12-3*f-20*b)/(4*b)||0]}};a.luv=function(d,c,e){var f,b,h,g;c=c||"D65";e=e||2;g=a.whitepoint[e][c][0];b=a.whitepoint[e][c][1];e=a.whitepoint[e][c][2];c=4*g/(g+15*b+3*e);g=9*b/(g+15*b+3*e);f=d[0];e=d[1];h=d[2];d=4*f/(f+15*e+3*h)||0;f=9*e/(f+15*e+3*h)||0;b=e/b;b=.008856451679035631>=b?903.2962962962961*b:116*Math.pow(b,1/3)-16;return[b,13*b*(d-c),13*b*(f-g)]}},{"./rgb":14,"./xyz":15}],13:[function(f,
g,k){(function(){var a,d,c,e,f,b,h,k,q,r,x,y,s,n,p,v,m,w,t;s={R:[3.240969941904521,-1.537383177570093,-.498610760293],G:[-.96924363628087,1.87596750150772,.041555057407175],B:[.055630079696993,-.20397695888897,1.056971514242878]};a=[.41239079926595,.35758433938387,.18048078840183];d=[.21263900587151,.71516867876775,.072192315360733];c=[.019330818715591,.11919477979462,.95053215224966];r=function(a){var c,b,d,e,f,g,h,l,k,m,q,r,n,p;f=Math.pow(a+16,3)/1560896;g=.0088564516<f?f:a/903.2962962;f=[];n=["R",
"G","B"];k=0;for(q=n.length;k<q;k++)for(b=n[k],e=s[b],b=e[0],d=e[1],e=e[2],p=[0,1],m=0,r=p.length;m<r;m++)c=p[m],h=(284517*b-94839*e)*g,l=(838422*e+769860*d+731718*b)*a*g-769860*c*a,c=(632260*e-126452*d)*g+126452*c,f.push([h/c,l/c]);return f};x=function(a,c){return(a[1]-c[1])/(c[0]-a[0])};h=function(a){return Math.sqrt(Math.pow(a[0],2)+Math.pow(a[1],2))};y=function(a,c){var b;b=c[0];b=c[1]/(Math.sin(a)-b*Math.cos(a));return 0>b?null:b};p=function(a){var c,b,d,e,f,g;b=[];g=r(a);e=0;for(f=g.length;e<
f;e++)c=g[e],a=c[0],c=c[1],d=x([a,c],[-1/a,0]),b.push(h([d,c+d*a]));return Math.min.apply(Math,b)};n=function(a,c){var b,d,e,f,g,h;b=c/360*Math.PI*2;e=[];h=r(a);f=0;for(g=h.length;f<g;f++)d=h[f],d=y(b,d),null!==d&&e.push(d);return Math.min.apply(Math,e)};k=function(a,c){var b,d,e,f;b=e=d=0;for(f=a.length-1;0<=f?e<=f:e>=f;b=0<=f?++e:--e)d+=a[b]*c[b];return d};w=function(a,c){var b;b=Math.pow(10,c);return Math.round(a*b)/b};q=function(a){return.0031308>=a?12.92*a:1.055*Math.pow(a,1/2.4)-.055};t=function(a){return.04045<
a?Math.pow((a+.055)/1.055,2.4):a/12.92};v=function(a){var c,b,d,e;e=[];b=0;for(d=a.length;b<d;b++)c=a[b],e.push(w(c,3));a=e;b=0;for(d=a.length;b<d;b++)if(c=a[b],-1E-4>c||1.0001<c)throw Error("Illegal rgb value: "+c);e=[];b=0;for(d=a.length;b<d;b++)c=a[b],e.push(Math.round(255*c));return e};b={xyz:{},luv:{},lch:{},husl:{},huslp:{},rgb:{},hex:{}};b.xyz.rgb=function(a){var c,b;b=q(k(s.R,a));c=q(k(s.G,a));a=q(k(s.B,a));return[b,c,a]};b.rgb.xyz=function(b){var e,f;f=b[0];e=b[1];b=b[2];b=[t(f),t(e),t(b)];
e=k(a,b);f=k(d,b);b=k(c,b);return[e,f,b]};f=function(a){return.0088564516>=a?a/1*903.2962962:116*Math.pow(a/1,1/3)-16};e=function(a){return 8>=a?1*a/903.2962962:1*Math.pow((a+16)/116,3)};b.xyz.luv=function(a){var b,c,d;c=a[0];b=a[1];d=a[2];a=4*c/(c+15*b+3*d);c=9*b/(c+15*b+3*d);b=f(b);return 0===b?[0,0,0]:[b,13*b*(a-.19783000664283),13*b*(c-.46831999493879)]};b.luv.xyz=function(a){var b,c;b=a[0];c=a[1];a=a[2];if(0===b)return[0,0,0];c=c/(13*b)+.19783000664283;a=a/(13*b)+.46831999493879;b=e(b);c=0-9*
b*c/((c-4)*a-c*a);return[c,b,(9*b-15*a*b-a*c)/(3*a)]};b.luv.lch=function(a){var b,c,d;c=a[0];b=a[1];d=a[2];a=Math.pow(Math.pow(b,2)+Math.pow(d,2),.5);b=360*Math.atan2(d,b)/2/Math.PI;0>b&&(b=360+b);return[c,a,b]};b.lch.luv=function(a){var b,c,d;d=a[0];b=a[1];c=a[2]/360*2*Math.PI;a=Math.cos(c)*b;b*=Math.sin(c);return[d,a,b]};b.husl.lch=function(a){var b,c,d;b=a[0];c=a[1];a=a[2];if(99.9999999<a)return[100,0,b];if(1E-8>a)return[0,0,b];d=n(a,b);return[a,d/100*c,b]};b.lch.husl=function(a){var b,c,d;c=a[0];
b=a[1];a=a[2];if(99.9999999<c)return[a,0,100];if(1E-8>c)return[a,0,0];d=n(c,a);return[a,b/d*100,c]};b.huslp.lch=function(a){var b,c,d;b=a[0];c=a[1];a=a[2];if(99.9999999<a)return[100,0,b];if(1E-8>a)return[0,0,b];d=p(a);return[a,d/100*c,b]};b.lch.huslp=function(a){var b,c,d;c=a[0];b=a[1];a=a[2];if(99.9999999<c)return[a,0,100];if(1E-8>c)return[a,0,0];d=p(c);return[a,b/d*100,c]};b.rgb.hex=function(a){var b,c,d,e;c="#";a=v(a);d=0;for(e=a.length;d<e;d++)b=a[d],b=b.toString(16),1===b.length&&(b="0"+b),c+=
b;return c};b.hex.rgb=function(a){var b,c,d,e;"#"===a.charAt(0)&&(a=a.substring(1,7));c=a.substring(0,2);b=a.substring(2,4);a=a.substring(4,6);d=[c,b,a];e=[];c=0;for(a=d.length;c<a;c++)b=d[c],e.push(parseInt(b,16)/255);return e};b.lch.rgb=function(a){return b.xyz.rgb(b.luv.xyz(b.lch.luv(a)))};b.rgb.lch=function(a){return b.luv.lch(b.xyz.luv(b.rgb.xyz(a)))};b.husl.rgb=function(a){return b.lch.rgb(b.husl.lch(a))};b.rgb.husl=function(a){return b.lch.husl(b.rgb.lch(a))};b.huslp.rgb=function(a){return b.lch.rgb(b.huslp.lch(a))};
b.rgb.huslp=function(a){return b.lch.huslp(b.rgb.lch(a))};m={fromRGB:function(a,c,d){return b.rgb.husl([a,c,d])},fromHex:function(a){return b.rgb.husl(b.hex.rgb(a))},toRGB:function(a,c,d){return b.husl.rgb([a,c,d])},toHex:function(a,c,d){return b.rgb.hex(b.husl.rgb([a,c,d]))},p:{}};m.p.toRGB=function(a,c,d){return b.xyz.rgb(b.luv.xyz(b.lch.luv(b.huslp.lch([a,c,d]))))};m.p.toHex=function(a,c,d){return b.rgb.hex(b.xyz.rgb(b.luv.xyz(b.lch.luv(b.huslp.lch([a,c,d])))))};m.p.fromRGB=function(a,c,d){return b.lch.huslp(b.luv.lch(b.xyz.luv(b.rgb.xyz([a,
